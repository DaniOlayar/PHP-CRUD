    ...
    <form class="rog g-3" method="POST" action="process.php">
      ...
      <div class="row mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="states" value="<?php echo $states; ?>" required>
        </div>
      <div class="row mb-3">
        <div class="col">
        ...
        <button type="submit" class="btn btn-primary" name="update" style="width: 10%;">Update</button>
